                            ...
                            <tr>
                                ...
                                <td><label class="switch">
                                            <input type="checkbox" onchange="changeStatus(event.target,'{{$model->id}}')"
                                                                                       <?php 
                                            if($model->unit_status == "1"){echo"checked";}else{ echo "unchecked";}
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    $.each(Result, function(key, value) {
                        var status = value.unit_status;
                        var StatusRes = "unchecked";
                        if(status =="1"){
                            StatusRes = "checked";
                        }
                        var editurl = '{{ route('unit.edit', ':id') }}';
                        editurl = editurl.replace(':id', value.id);

                        var deleteurl = '{{ route('unit.destroy', ':id') }}';
