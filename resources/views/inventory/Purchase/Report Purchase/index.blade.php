@extends('layouts.app', ['page' => 'List of Report', 'pageSlug' => 'report', 'section' => 'PurchaseMaster'])
        ...
        <div class="row">
            ...
            <div class="middle col-md-3 col-md-push-3 col-sm-3">
                ...
                font-size: 20px;text-align: center; ">
                        ...
                        <div class="tee" style="font-size: 20px;color: #fff;">Paid</div>
                    </div>
                </div>
            </div>
            <div class="last col-md-3 col-sm-3 ">
                ...
                font-size: 20px;text-align: center;">
                        ...
                        <div class="tee" style="font-size: 20px;color: #fff;">Unpaid</div>
                    </div>
                </div>
            </div>
            ...
            <div class="card-header">
                <div class="row">
                    ...
                    <div class="col-4 text-right">
                        <a href="{{ route('report.create') }}" class="btn btn-sm btn-primary"> Add Purchase</a>
                    </div>
                </div>
            </div>
            <div class="card-body">
...
<script>
    ...
    function splidata(type) {
        console.log(type);
        $.ajax({
            url: "{{ route('getReportRelatedData')  }}",
            type: "post",
            data: type,
            data: {
                _token: '{{ csrf_token() }}',
            ...
            success: function(response) {
                ...
                var Result = response.data;
                    ...
                    $.each(Result, function(key, value) {
                        var editurl = '{{ route('report.edit', ':id') }}';
                        editurl = editurl.replace(':id', value.id);

                        var deleteurl = '{{ route('report.destroy', ':id') }}';
                    ...
                    var row = `<tr role="row" class="odd"><td>` + (key + 1) + `</td>
