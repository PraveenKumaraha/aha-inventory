@extends('layouts.app', ['page' => 'List of BloodGroup', 'pageSlug' => 'bloodgroup', 'section' => 'BasicMaster'])
            ...
            <div class="card-header">
                <div class="row">
                    ...
                    <div class="col-4 text-right">
                        <a href="{{ route('bloodGroup.create') }}" class="btn btn-sm btn-primary">New BloodGroup</a>
                    </div>
                </div>
            </div>
            <div class="card-body">
                            ...
                            <tr>
                                ...
                                <td>{{ $model->name }}</td>
                                    ...
                                    <td class="td-actions">
                                        ...
                                        <a href="{{ route('bloodGroup.edit', $model->id) }}" class="btn btn-link" data-toggle="tooltip" data-placement="bottom" title="Edit Product">
                                            <i class="tim-icons icon-pencil"></i>
                                        </a>
                                        <form action="{{ route('bloodGroup.destroy', $model->id) }}" method="post" class="d-inline">
                                            @csrf
                                            @method('delete')
