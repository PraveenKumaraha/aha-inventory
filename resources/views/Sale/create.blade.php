                            ...
                            <div class="col-xl-12 order-xl-1">
                                ...
                                <div class="card-body">
                                    <form id='create' action="" enctype="multipart/form-data" method="POST"
                                        accept-charset="utf-8" class="create needs-validation" novalidate
                                        autocomplete="off">
                                        @csrf
                                        ...
                                        <div class="container-sm"
                                            style="width:100%;border-style: solid;border-color: coral;">

                                            <div class="form-row">
                                                <label class=" col-form-label" for="name">Customer/Company name:</label>
                                                <input type="text" class="form-control col-sm-2" name="cname"
                                                    id="cname" />
                                                    <span id="error_cname" class="has-error"></span>
                                                <label class=" col-form-label" for="name">Customer Number:</label>
                                                <input type="text" class="form-control col-sm-2" name="cnumber"
                                                    id="name" required/>
                                            </div>

                                            <div class="form-row">
                                                <label class=" col-form-label1" for="name">GSTIN:</label>
                                                <input type="text" class="form-control col-sm-2" name="gstin"
                                                    id="gstin" required/>
                                                    ...
                                                    <tr class="1" id="row1">
                                                        <td data-select2-id="1">
                                                            <div class="form-group">
                                                                <select class="form-control	select2 productName1"
                                                                    style="width:150px;height:80px!important"
                                                                    id="productName1" name="product_name[]"
                                                                    onchange="getProductData(1)" required>
                                                                    <option value="" selected="selected" disabled>
                                                                        Select Product</option>
                                                                    <?php foreach ($pdtproductIds as $row) { ?> <option value="<?php echo $row['id']; ?>"
                                                                        a_price="<?php echo $row['a_price']; ?>"><?php echo $row['product_id']; ?> |
                                                        ...
                                                        <td data-select2-id="1">
                                                            <div class="form-group">
                                                                <select class="form-control	select2"
                                                                    style="width:150px;height:80px!important" id="tax1"
                                                                    name="tax[]" onchange="getTaxData(1)" required>
                                                                    <option value="0" selected="selected" disabled>
                                                                        Select Tax</option>
                                                                    <?php foreach ($pdttaxids as $row) { ?> <option value="<?php echo $row['id']; ?>"
                                                                        taxValue="<?php echo $row['tax_value']; ?>"><?php echo $row['tax_name']; ?>
                                                                    </option>
                                                                    <?php } ?>
                                                                </select>
                                                            </div>
                                                        ...
                                                        <td>
                                                            ...
                                                            <a class="delete" title="Delete" data-toggle="tooltip"
                                                                onclick="removeProductRow(1)"><i class="material-icons"
                                                                    style="color:red">&#xE872;</i></a>
                                                        </td>
                                                    </tr>
                                                </div>
                                        ...
                                        <button type="button" class="btn btn-primary add_field" id="addRowBtn"
                                            onclick="addRow()">add Pdt</button>
                                </div>
                                </form>
                            </div>
                        </div>
