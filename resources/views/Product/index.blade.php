            ...
            <div class="card-header">
                <div class="row">
                    ...
                    <div class="col-4 text-right">
                        <a href="{{ route('stockproduct.create') }}" class="btn btn-sm btn-primary">New Product</a>
                    </div>
                </div>
            </div>
            <div class="card-body">
                    ...
                    <table class="table tablesorter " id="">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="td-actions">
                                    <a href="{{ route('stockproduct.edit', $model->id) }}" class="btn btn-link" data-toggle="tooltip" data-placement="bottom" title="Edit Product">
                                        <i class="tim-icons icon-pencil"></i>
                                    </a>
                                    <form action="{{ route('stockproduct.destroy', $model->id) }}" method="post" class="d-inline">
                                        @csrf
                                        @method('delete')
