            ...
            <div class="card">
                <div class="card-header">
                    <div class="row align-items-center">
                        <div class="col-8">
                            <h3 class="mb-0">New Stockproduct</h3>
                        </div>
                        <div class="col-4 text-right">
                            <a href="{{ route('stockproduct.index') }}" class="btn btn-sm btn-primary">Back to List</a>
                        </div>
                    </div>
                </div>
                <div class="card-body">
                    <form method="post" action="{{ route('stockproduct.store') }}" autocomplete="off">
                        @csrf
                        <div class="pl-lg-4">
                        ...
                        <div class="pl-lg-4">
                            <div class="form-group{{ $errors->has('name') ? ' has-danger' : '' }}">
                                ...
                                <select name="product_brand_id" id="catgory" class="form-control brand" required>
                                    <option value="">Select Unit</option>
                                    @foreach($pdtBrands as $pdtBrand)
                                    <option value="<?php echo $pdtBrand->id; ?>"><?php echo $pdtBrand->name; ?></option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="pl-lg-4">
                            <div class="form-group{{ $errors->has('name') ? ' has-danger' : '' }}">
                                ...
                                <select name="product_category_id" id="catgory" class="form-control category" required>
                                    <option value="">Select category</option>
                                    @foreach($pdtCatgorys as $pdtCatgory)
                                    <option value="<?php echo $pdtCatgory->id; ?>"><?php echo $pdtCatgory->name; ?></option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                        <div class="pl-lg-4">
                            <div class="form-group{{ $errors->has('name') ? ' has-danger' : '' }}">
                                ...
                                <select name="product_unit_id" id="catgory" class="form-control unit" required>
                                    <option value="">Select Unit</option>
                        ...
                        <div class="pl-lg-4">
                            <div class="form-group{{ $errors->has('name') ? ' has-danger' : '' }}">
                                ...
                                <input type="number" name="actual_price" id="input-name" class="form-control form-control-alternative{{ $errors->has('name') ? ' is-invalid' : '' }}" placeholder="stockproduct Name" value="{{ old('name') }}" required autofocus>
                                @include('alerts.feedback', ['field' => 'name'])
                            </div>
                        </div>
                        ...
                        <div class="pl-lg-4">
                            <div class="form-group{{ $errors->has('name') ? ' has-danger' : '' }}">
                                ...
                                <input type="number" name="selling_price" id="input-name" class="form-control form-control-alternative{{ $errors->has('name') ? ' is-invalid' : '' }}" placeholder="stockproduct Name" value="{{ old('name') }}" required autofocus>
                                @include('alerts.feedback', ['field' => 'name'])
                            </div>
                        </div>
