@extends('layouts.app', ['page' => 'List of ReturnPurchase', 'pageSlug' => 'returnPurchase', 'section' => 'PurchaseMaster'])
...
<script src="//ajax.googleapis.com/ajax/libs/jquery/1.9.1/jquery.min.js"></script>
    ...
    <script>
        ...
        function splitData(type) {
            ...
            $.ajax({
                url: "{{ route('getPurchaseSplitedData') }}",
                type: "post",
                data: type,
                data: {
                    _token: '{{ csrf_token() }}',
                ...
                success: function(response) {
                    ...
                    $.each(Result, function(key, value) {
                        var editurl = '{{ route('purchase.edit', ':id') }}';
                        editurl = editurl.replace(':id', value.id);

                        var deleteurl = '{{ route('purchase.destroy', ':id') }}';
