<div class="sidebar">
    <div class="sidebar-wrapper">
        <ul class="nav">
            ...
            <li>
                <a data-toggle="collapse" href="#BasicMaster" {{ $section == 'BasicMaster' ? 'aria-expanded=true' : '' }}>
                    <i class="tim-icons icon-controller"></i>
                    <span class="nav-link-text">Basic Masters</span>
                    <b class="caret mt-1"></b>
                </a>

                <div class="collapse {{ $section == 'BasicMaster' ? 'show' : '' }}" id="BasicMaster">
                    <ul class="nav pl-4">
                        <!-- <li  @if ($pageSlug == 'gender') class="active " @endif>
                            <a href="">
                                <i class="tim-icons icon-user-run"></i>
                                <p>Gender</p>
                            </a>
                        </li>
                        <li @if ($pageSlug == 'bloodgroup') class="active " @endif>
                            <a href="{{ route('bloodGroup.index')  }}">
                                <i class="tim-icons icon-blood-group"></i>
                                <p>Blood Group</p>
                            </a>
                        </li> -->
                        <!-- <li @if ($pageSlug == 'Country') class="active " @endif>
                        ...
                        <li @if ($pageSlug=='unit' ) class="active " @endif>
