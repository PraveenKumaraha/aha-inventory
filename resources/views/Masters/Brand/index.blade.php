                                ...
                                @foreach ($models as $model)
                                    <tr>
                                        ...
                                        <td class="td-actions">
                                            ...
                                            <a href="{{ route('brand.edit', $model->id) }}" class="btn btn-link"
                ...
                success: function(response) {
                    ...
                    $.each(Result, function(key, value) {
                        ...
                        var row = `<tr role="row" class="odd"><td>` + (key + 1) + `</td><td>` + value
                            .brand_name + `</td><td><label class="switch"> <input type="checkbox" onchange="changeStatus(event.target,`+value.id+`)" `+StatusRes+` ><span class="slider round"></span></label></td><td class="td-actions"><a href ="` + editurl +
